 ...
 */
public class Info1 extends ActionBarActivity {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            ...
                            if (drawerItem.getIdentifier() == 0) {
                                startActivity(new Intent(Info1.this, MainActivity.class));
                            } else if (drawerItem.getIdentifier() == 1) {
                                startActivity(new Intent(Info1.this, PollingStationActivity.class));
                            } else if (drawerItem.getIdentifier() == 2) {
                                startActivity(new Intent(Info1.this, Map.class));
                            } else if (drawerItem.getIdentifier() == 3) {
                                startActivity(new Intent(Info1.this, NearestVenue.class));
                            } else if (drawerItem.getIdentifier() == 4) {
                                startActivity(new Intent(Info1.this, ShareActivity.class));
                            }
                        }
                    }
                })
    ...
    private void init() {
        ...
        ibForward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Info1.this, Info2.class));
            }
        });
    }
}
